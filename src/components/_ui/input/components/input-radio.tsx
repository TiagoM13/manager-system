        ...
        <Controller
          ...
          render={({ field }) => (
            <input
              ...
              type="radio"
              className={`h-[12px] w-[12px] cursor-pointer appearance-none rounded-full border border-slate-600 transition-all duration-500 ease-in checked:bg-sky-600 checked:hover:bg-sky-500 disabled:cursor-auto disabled:opacity-60 ${!props.disabled ? 'hover:bg-sky-200' : ''}`}
            />
          )}
        />
      ) : (
